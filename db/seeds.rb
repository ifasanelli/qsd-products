...
plan = Plan.create!(name: 'TESTHOSPTEST41 BASICO',
                    product_type: product_type, details: 'Detalhe detalhado',
                    description: 'Descrição test',status: :available)
...
Plan.create!(name: 'Basic', description: 'Plano Básico', status: :available,
             product_type: ProductType.find_by_id(1),
             details: 'Plano básico contendo [x,y,z]')

Plan.create!(name: 'Pro', description: 'Plano Profissional', status: :available,
             product_type: ProductType.find_by_id(1),
